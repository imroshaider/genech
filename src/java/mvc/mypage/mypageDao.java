...
String user=null;
  ...
  File imagee= new File("C:\\apache-tomcat-8.0.33\\webapps\\pbl3\\web\\Image\\" +image);
...
String query = "UPDATE  userprof SET name=?,age=?,sex=?,address=?,keep=?,image=?,post=? where ID='"+id+"'"; //Insert user details into the table 'USERS'
