...
public String kibouupdate(KibouBean kibouBean) throws IOException
{
  ...
  String People = kibouBean.getPeople();
  String Name=null;
  String zikan;
  Integer count=0;
...
String query = "insert into travelsearch(ID,Name,Des1,Des2,Des3,Cost,Hope,zikan,CheckIn,Checkout,people,count) values (?,?,?,?,?,?,?,?,?,?,?,?)"; //Insert user details into the table 'USERS'
