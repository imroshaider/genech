     ...
     <div class="panel panel-primary">
             <div class="panel-body"><div class="media">
                ...
                <h4 class="media-heading">
                                      <!--↓pop up-->
          <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#Modal_3">
                             user名
                            </button>
...
ResultSet x =preparedStatement.executeQuery();
 ...
 while(x.next()){
                          hope=x.getString("Hope");
                           id=x.getString("ID");
                          String query1 = "select address,post,keep from userprof where ID='"+id+"'";
                         preparedStatement = con.prepareStatement(query1);
                      ResultSet y =preparedStatement.executeQuery();

                  while(y.next()){ 
     
     address = y.getString("post");
     address +=y.getString("address");
     hoby=y.getString("keep");

}
    out.println("<div class='col-sm-6'><br><div class='panel panel-primary'>");
             out.println("<div class='panel-body'><div class='media'>");

               

                  out.println("<div class='media-body'><!-- 必要なデータ　ユーザーの情報(ID,prof)、希望情報(場所、予算、チェックイン/アウト、提案数)　-->");
                 out.println("<h4 class='media-heading'><!--↓pop up-->");
                                      
          out.println("<button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-target='#Modal_1'>user名</button>");
                            ...
                            out.println("<div class='modal-body'><div class='box2'><span class='box-title'>User Name</span>");
                                ...
                                out.println("<tr><th>住所:"+ address +"</th><th></th></tr>");
                               out.println(" <tr><th>趣味："+ hoby +"</th><th></th></tr>");
                                out.println("<tr><th>過去の訪問：</th><th></th></tr>");
                                out.println("<tr><th>コメント："+ hope +"</th><th></th></tr>");                               
...
%>
                        ...
                        <!-- モーダル・ダイアログ -->
                            ...
                            <div class="modal-body">
                              ...
                              <span class="box-title">User Name</span>
                                ...
                                <tr><th>住所：<%=address%></th><th></th></tr>
                                <tr><th>趣味：<%=hoby%></th><th></th></tr>
                                <tr><th>過去の訪問：</th><th></th></tr>
                                <tr><th>コメント：<%=hope%></th><th></th></tr>                         
                                <br>
                                </table>
                              </div>
      ...
      <form action="">
          <div align="left"><strong>5</strong>件の企業が提案</div>
                      <!--↓pop up-->
          <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#Modal_4">
                             提案済
                            </button>
