...
<body>
  ...
  <form name="form" action="Profileservlet" method="post" onsubmit="return validate()">
    ...
    <br>
    <img src="img/00.jpg" class="img-circle img1">
  ...
  <div class="col-md-5">
   ...
   <div class="form">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="username" placeholder="name" style="width:200px;" rows="1" maxlength="14">
      ...
      <p><label for="keep">About yourSelf</label></p>
            <textarea class="form-control" style="width:300px;" name="keep" placeholder="yourself" rows="1" maxlength="60"></textarea>
        </div>
      <p>
    		<div class="form-group">
